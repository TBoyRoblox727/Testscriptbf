if game.CoreGui:FindFirstChild("MadoxLib") then
    game.CoreGui:FindFirstChild("MadoxLib"):Destroy()
end
...
function Blacklib:Window()
    ...
    local MadoxLib = Instance.new("ScreenGui")
    ...
    -- Propertiers --
    MadoxLib.Name = "MadoxLib"
    MadoxLib.Parent = game.CoreGui
    MadoxLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    
    Points.Name = "Points"
    Points.Parent = MadoxLib
